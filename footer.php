        ...
        <div class="row pb-100">
            <div class="col-lg-3 col-sm-6 col-md-6" data-cue="slideInUp">
                <div class="footer-widget">
                    <a href="index.php">
                        <img src="assets/images/headerlogo-removebg-preview.png" class="black-logo" alt="logo">
                        <img src="assets/images/headerlogo-removebg-preview.png" class="white-logo" alt="logo">
                    </a>
...
">At Swamitra Insurance, we are committed to providing innovative and reliable insurance solutions that protect what
            ...
            <div class="col-lg-4 col-sm-6 col-md-6" data-cue="slideInUp">
                    ...
                    <ul class="footer-widget-list">
                        ...
                        <li>
                            <a href="./about.php"><i class="bx bx-chevron-right"></i>Company Profile</a>
                        </li>
